...
Client.prototype.getMissedNotification = function() {
    ...
    var lostNotifications;
    for(var i=0; i<this.team.notifications.length; i++) {
        var n = this.team.notifications[i];
...
Team.prototype.emit = function(event, payload) {
    var _this = this;
    _this.notifications.push(new Notification(event, payload));
